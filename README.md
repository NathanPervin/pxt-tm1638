# micro:bit MakeCode extension for TM1638 based devices
Tested on [this device](https://www.handsontec.com/dataspecs/display/TM1638.pdf)

## initialize Block #tm1638-initialize
...
## clear board/reset Block #tm1638-reset
...
### Example
```javascript
tm1638.setDecimalPoint(tm1638.SelectDigit.One, true)
```
